...
def test_copy_activities_functional_edge_to_product():
    ...
    source_db.write({
        ("source_db", "process_A"): {
            ...
            "type": "process",
            "exchanges": [
                {"input": ("source_db", "product_X"), "amount": 1.0, "type": "production", "functional": True},
...
def test_copy_activities_target_same_as_source():
    ...
    with pytest.raises(ValueError, match="Target database 'source_db' must be different from the source database"):
...
def test_copy_activities_non_process_no_product_copy():
    ...
    source_db.write({
        ("source_db", "product_A"): {
            ...
            "type": "product",
            "exchanges": [
                {"input": ("source_db", "product_B"), "amount": 1.0, "type": "processwithreferenceproduct"},
            ]
        },
        ("source_db", "product_B"): {
            "name": "Product B",
...
def test_copy_activities_multiple_with_products_and_references():
    ...
    source_db.write({
        ...
        ("source_db", "process_B"): {
            ...
            "type": "process",
            "exchanges": [
                {"input": ("source_db", "product_Y"), "amount": 1.0, "type": "production", "functional": True},
